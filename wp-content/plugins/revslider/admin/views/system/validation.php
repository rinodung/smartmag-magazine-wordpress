...
<div id="rs-validation-wrapper" style="display:<?php echo $displ; ?>">
	...
	<div class="validation-input">
		...
		<p class="validation-description"><?php _e('You can find the API key by visiting your Envato Account page, then clicking the My Settings tab. At the bottom of the page you will find your accounts API key.',REVSLIDER_TEXTDOMAIN); ?></p>
	</div>
	<div class="clear"></div>
